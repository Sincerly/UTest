...
import com.ysxsoft.utest.models.response.List2Response;
 ...
 **/
@Route(path = "/main/List2Activity")
public class List2Activity extends BaseActivity implements IListAdapter<String> {
    ...
    public static void start(){
        ARouter.getInstance().build(ARouterPath.getList2Activity()).navigation();
    }
    ...
    public int getItemLayoutId() {
        return R.layout.item_list2_activity_list;
    }
    ...
    public void request(int page) {
        if(IS_DEBUG_ENABLED){
            ...
            OkHttpUtils.post()
                    .url(Api.GET_LIST2_LIST)
                    .addParams("uid", SharedPreferencesUtils.getUid(List2Activity.this))
                    ...
                    .execute(new StringCallback() {
                        ...
                        public void onResponse(String response, int id) {
                            manager.releaseRefresh();
                            List2Response resp = JsonUtils.parseByGson(response, List2Response.class);
                            if (resp != null) {
//                                if (HttpResponse.SUCCESS.equals(resp.getCode())) {
//                                    //请求成功
//                                    List<List2Response.DataBean> data = resp.getData();
